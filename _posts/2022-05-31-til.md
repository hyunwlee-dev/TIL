---
layout: post
title: "JS _변수, 코딩 컨벤션, JS Priority Queue"
author: "hyunwlee"
---
...
1. 언더바(_)는 주로 함수의 매개변수를 선언할 때 사용한다.  
...
함수의 매개변수로 언더바(_)를 사용하는 것을 JavaScript 개발자들의 관습이라고 할 수 있다.  

normalFunc의 첫 번째 매개변수가 중요하지 않다는 것을 표현하기 위해 언더바(_)로 선언한다.  

2. 화살표 함수의 매개변수가 존재하지 않은 경우에 사용된다.  
...
3. 내부에서만 사용할 변수나 함수에 사용한다.



# Javascript스러운 Priority Queue
...
> ref: [stackoverflow: Efficient way to implement Priority Queue in Javascript?](https://stackoverflow.com/questions/42919469/efficient-way-to-implement-priority-queue-in-javascript)
